import {
  ...
  buildingForm, urbanSetting, urbanBands, budgetBand, parkingStanding, doubleDownOn, focusUnknowns,
...
function renderDiscover() {
  ...
  $("#filter-highRise").addEventListener("change", () => {
    prefs.highRise = $("#filter-highRise").checked;
    persist(); renderResults(); bindCards();
  });
